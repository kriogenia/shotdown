...
/* Reload */
constexpr auto NOVA_RELOAD_TIME = 2.4 * TARGET_FPS; // 2.43s
constexpr auto NOVA_WAIT_TIME = 1.1 * static_cast<double>(TARGET_FPS); // 0.3s
/* Recoil */
constexpr auto NOVA_RECOIL_FORCE = 120 * TARGET_FPS;
/* Projectile */
constexpr auto NOVA_PELLETS = 3;
constexpr auto NOVA_DISPERSION = 1;
constexpr auto NOVA_PROJECTILE_LIFE = 0.3 * static_cast<double>(TARGET_FPS); // 0.6s
